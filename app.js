...
const MONGODB_URI = 'mongodb+srv://root:root@cluster0.0n77a.mongodb.net/ShopDb?retryWrites=true&w=majority'
  //`mongodb://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@localhost:27017/${process.env.MONGO_DEFAULT_DATABASE}?authSource=admin&readPreference=primary&appname=MongoDB%20Compass&ssl=false`;
